...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="shortcut icon" type="image/jpg" href="../ico.ico">
...
<script type="text/javascript">
    ...
    document.getElementById('findInput').value='the';
  ...
  <body tabindex="1">
  	...
  	<div id="topMenu">
  		<input type="Text" id="searchinput" name="searchtext" placeholder="Fuzzy search.."> <button class="searchbtn" id="searchbtn" >Fuzzy search</button>
  		<br>
  		<!-- <div id="infobox" >
